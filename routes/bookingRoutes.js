...
import { createBooking, deleteBooking, getBookedDatesByRoom, getHostBookingData, getMyBookings } from "../controllers/bookingControllers.js";
...
router.get('/host-room-booking-info/:hostEmail',verifyFbToken,verifyHost,getHostBookingData)
